...
from bots.group72_bot_combined import group72_bot_combined
...
for i in range(STEPS):
    for j in range(100):
            ...
            player2 = group72_bot_combined.Bot()
...
names = [ str(won_by_1) + ' games group72_bot_plain_ml', str(won_by_2) +  ' games group72_bot_combined_ml' + '\n p_value=' + str(p_value)]
...
plt.savefig('experiment_'  + '_seed' + str(seed) +'group72_bot_plain_ml_vs_group72_bot_combined_1000_games.pdf')
