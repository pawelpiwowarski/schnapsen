...
from bots.group72_bot_aces_ml import group72_bot_aces_ml
...
for i in range(STEPS):
    for j in range(100):
            ...
            player2 = group72_bot_aces_ml.Bot()
...
names = [ str(won_by_1) + ' games group72_bot_plain_ml', str(won_by_2) +  ' games group72_bot_aces_ml' + '\n p_value=' + str(p_value)]
...
plt.savefig('experiment' + '_seed'+ str(seed)+'_group72_bot_plain_ml_vs_group72_bot_aces_ml_1000_games.pdf')
