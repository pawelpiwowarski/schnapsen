...
from bots.group72_bot_combined.group72_bot_combined import features
...
def create_dataset(path, player=rand.Bot(), games=2000, phase=1):
    ...
    for g in range(games-1):
        ...
        while not state.finished():
            ...
            state_vectors.append(features(given_state, h))
...
if options.train:
    ...
    joblib.dump(model, "./bots/group72_bot_combined/" + options.model_path)
